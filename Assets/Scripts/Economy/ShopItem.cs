...
public class ShopItem
{
    ...
    public Rarity        Rarity;      // rarity used for buyable items only
    ...
    {
        ItemType.Seed =>
            (int)(Crop.seedCost * RarityUtility.PriceMultiplier(Rarity)),
        ItemType.Placeable =>
            (int)(Placeable.unlockCost * RarityUtility.PriceMultiplier(Rarity)),
        _=> 0
    };
